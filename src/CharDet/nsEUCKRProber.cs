...
{
    class nsEUCKRProber : AbstractCSProber
    {
        ...
        private EUCKRDistributionAnalysis mDistributionAnalyser = new EUCKRDistributionAnalysis();
        ...
        public override string CharSetName { get { return "EUC-KR"; } }
