...
{
    class nsEUCTWProber : AbstractCSProber
    {
        nsEUCTWProber()
        {
        ...
        private EUCTWDistributionAnalysis mDistributionAnalyser= new EUCTWDistributionAnalysis();
        ...
        public override string CharSetName { get { return "x-euc-tw"; } }
