...
{
    class nsEUCJPProber : AbstractCSProber
    {
        ...
        private EUCJPContextAnalysis mContextAnalyser = new EUCJPContextAnalysis();
        private EUCJPDistributionAnalysis mDistributionAnalyser = new EUCJPDistributionAnalysis();
        ...
        public override string CharSetName { get { return "EUC-JP"; } }
