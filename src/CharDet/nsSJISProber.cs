...
{
    class nsSJISProber : AbstractCSProber
    {
        public nsSJISProber()
        {
        ...
        private SJISContextAnalysis mContextAnalyser = new SJISContextAnalysis();
        private SJISDistributionAnalysis mDistributionAnalyser = new SJISDistributionAnalysis();
        ...
        public override string CharSetName { get { return "Shift_JIS"; } }
